...
/** Alle noch nicht verteilten Contests (artistübergreifend) — für den täglichen Auto-Distribute-Cron */
...
/** Alle Artists mit gespeicherter Quartals-Reward-Konfiguration — für den täglichen Auto-Distribute-Cron */
