...
const dict: Translations = {
  ...
  'rep.leaderboardInfoTitle': { de: 'Was ist das Leaderboard?', en: 'What is the leaderboard?', pl: 'Czym jest tabela wyników?' },
  'rep.leaderboardInfoBody': {
    de: 'Das Leaderboard zeigt, welche Fans die meiste Reputation bei diesem Künstler gesammelt haben. Reputation bekommst du, wenn du Quests dieses Künstlers im Quest Board abschließt. Am Ende jedes Quartals gewinnen die vorderen Plätze die angezeigten Preise.',
    en: 'The leaderboard shows which fans have earned the most reputation with this artist. You earn reputation by completing this artist\'s quests in the Quest Board. At the end of each quarter, the top ranks win the prizes shown here.',
    pl: 'Tabela wyników pokazuje, którzy fani zdobyli najwięcej reputacji u tego artysty. Reputację zdobywasz, wykonując questy tego artysty w Quest Board. Na koniec każdego kwartału najlepsze miejsca wygrywają pokazane tu nagrody.',
  },
  'rep.contestInfoTitle': { de: 'Was ist der Contest?', en: 'What is the contest?', pl: 'Czym jest konkurs?' },
  'rep.contestInfoBody': {
    de: 'Bei einem Contest sammelst du innerhalb eines begrenzten Zeitraums Reputation, um unter den Top-Plätzen zu landen und Preise zu gewinnen. Reputation bekommst du, wenn du Quests dieses Künstlers im Quest Board abschließt.',
    en: 'In a contest you earn reputation within a limited time window to land a top spot and win prizes. You earn reputation by completing this artist\'s quests in the Quest Board.',
    pl: 'W konkursie zdobywasz reputację w ograniczonym czasie, aby znaleźć się w czołówce i wygrać nagrody. Reputację zdobywasz, wykonując questy tego artysty w Quest Board.',
  },
  'rep.goToQuestBoard': { de: 'Zum Quest Board', en: 'Go to Quest Board', pl: 'Przejdź do Quest Board' },
  ...
  'yt.errServiceUnavailable': { de: 'YouTube-Verknüpfung ist gerade nicht verfügbar. Bitte versuche es später erneut.', en: 'YouTube linking is currently unavailable. Please try again later.', pl: 'Łączenie z YouTube jest chwilowo niedostępne. Spróbuj ponownie później.' },
  'yt.errInvalidChannelInput': { de: 'Ungültige YouTube-Kanal-Eingabe. Bitte prüfe die URL oder den Handle.', en: 'Invalid YouTube channel input. Please check the URL or handle.', pl: 'Nieprawidłowy kanał YouTube. Sprawdź URL lub uchwyt.' },
  'yt.errApiUnreachable': { de: 'YouTube ist gerade nicht erreichbar. Bitte versuche es später erneut.', en: 'YouTube is currently unreachable. Please try again later.', pl: 'YouTube jest obecnie niedostępny. Spróbuj ponownie później.' },
  'yt.errApiError': { de: 'YouTube-API-Fehler. Bitte versuche es später erneut.', en: 'YouTube API error. Please try again later.', pl: 'Błąd API YouTube. Spróbuj ponownie później.' },
  'yt.errChannelNotFound': { de: 'YouTube-Kanal nicht gefunden. Prüfe URL oder Handle.', en: 'YouTube channel not found. Check the URL or handle.', pl: 'Nie znaleziono kanału YouTube. Sprawdź URL lub uchwyt.' },
  'yt.errCodeNotFound': { de: 'Code "{code}" nicht in der Kanal-Beschreibung gefunden. Speichere die Beschreibung und versuche es erneut.', en: 'Code "{code}" not found in the channel description. Save the description and try again.', pl: 'Kod "{code}" nie został znaleziony w opisie kanału. Zapisz opis i spróbuj ponownie.' },
  'yt.errDuplicateChannel': { de: 'Dieser YouTube-Kanal ist bereits mit einer anderen Wallet verknüpft.', en: 'This YouTube channel is already linked to another wallet.', pl: 'Ten kanał YouTube jest już połączony z innym portfelem.' },
  'yt.errDuplicateWalletChannel': { de: 'Diese Wallet ist bereits mit einem anderen YouTube-Kanal verknüpft.', en: 'This wallet is already linked to a different YouTube channel.', pl: 'Ten portfel jest już połączony z innym kanałem YouTube.' },
  'yt.errSaveFailed': { de: 'Fehler beim Speichern der Verknüpfung. Bitte versuche es erneut.', en: 'Failed to save the link. Please try again.', pl: 'Nie udało się zapisać połączenia. Spróbuj ponownie.' },
  ...
  'win.rewardRep':          { de: '+{n} REP', en: '+{n} REP', pl: '+{n} REP' },
  'win.rewardShard':        { de: '+{n} Shards', en: '+{n} Shards', pl: '+{n} Shardów' },
  ...
  'win.creditedBodyExtra':  { de: ' Plus {rep} REP und {shard} Shards.', en: ' Plus {rep} REP and {shard} Shards.', pl: ' Plus {rep} REP i {shard} Shardów.' },
  'win.creditedBodyExtraRep':   { de: ' Plus {rep} REP.', en: ' Plus {rep} REP.', pl: ' Plus {rep} REP.' },
  'win.creditedBodyExtraShard': { de: ' Plus {shard} Shards.', en: ' Plus {shard} Shards.', pl: ' Plus {shard} Shardów.' },
  ...
  'gw.repPerWinnerLabel':    { de: 'REP / Teilnehmer (optional)',  en: 'REP / participant (optional)',  pl: 'REP / uczestnika (opcjonalnie)' },
  'gw.shardPerWinnerLabel':  { de: 'Shards / Teilnehmer (optional)', en: 'Shards / participant (optional)', pl: 'Shardy / uczestnika (opcjonalnie)' },
  ...
  'gw.addPlatform':         { de: '+ Plattform hinzufügen',        en: '+ Add platform',              pl: '+ Dodaj platformę' },
  'gw.selectPlatform':      { de: 'Plattform wählen…',              en: 'Select platform…',            pl: 'Wybierz platformę…' },
  'gw.addPlatformSubmit':   { de: 'Plattform hinzufügen',           en: 'Add platform',                pl: 'Dodaj platformę' },
  ...
  'gw.plusRep':             { de: '+{n} REP', en: '+{n} REP', pl: '+{n} REP' },
  'gw.plusShard':           { de: '+{n} Shards', en: '+{n} Shards', pl: '+{n} Shardów' },
  ...
  'sv.errDuplicateHandle':  { de: 'Dieser {platform}-Account ist bereits mit einer anderen Wallet verknüpft.', en: 'This {platform} account is already linked to another wallet.', pl: 'To konto {platform} jest już połączone z innym portfelem.' },
  'sv.errTiktokUnavailable': { de: 'Profil von @{handle} konnte nicht abgerufen werden. TikTok blockiert gerade den Zugriff – bitte versuche es in 1–2 Minuten erneut.', en: 'Could not load the profile for @{handle}. TikTok is currently blocking access – please try again in 1–2 minutes.', pl: 'Nie udało się pobrać profilu @{handle}. TikTok chwilowo blokuje dostęp – spróbuj ponownie za 1–2 minuty.' },
  'sv.errTiktokBioEmpty':   { de: 'Deine TikTok-Bio von @{handle} ist leer. Bitte füge den Verifizierungscode in deine Bio ein und versuche es erneut.', en: 'Your TikTok bio for @{handle} is empty. Please add the verification code to your bio and try again.', pl: 'Twoje bio TikTok @{handle} jest puste. Dodaj kod weryfikacyjny do swojego bio i spróbuj ponownie.' },
  'sv.errFacebookNotConfigured': { de: 'Facebook-Verifikation ist gerade nicht verfügbar. Bitte versuche es später erneut.', en: 'Facebook verification is currently unavailable. Please try again later.', pl: 'Weryfikacja Facebooka jest chwilowo niedostępna. Spróbuj ponownie później.' },
  'sv.errInvalidInput':     { de: 'Ungültige Eingabe. Bitte lade die Seite neu und versuche es erneut.', en: 'Invalid input. Please reload the page and try again.', pl: 'Nieprawidłowe dane. Odśwież stronę i spróbuj ponownie.' },
};
