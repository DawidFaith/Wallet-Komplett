...
const dict: Translations = {
  ...
  'win.countdownLabel':     { de: 'Single erscheint in',          en: 'Single drops in',             pl: 'Singiel ukaże się za' },
  'win.releasedNow':        { de: '🎵 Ist jetzt erschienen!',      en: '🎵 Out now!',                  pl: '🎵 Już dostępny!' },
  'win.days':               { de: 'Tage',                         en: 'Days',                        pl: 'Dni' },
  ...
  'gw.releaseAtHint':       { de: 'Wird als Countdown auf der Gewinnspiel-Seite angezeigt.', en: 'Shown as a countdown on the giveaway page.', pl: 'Wyświetlane jako odliczanie na stronie konkursu.' },
