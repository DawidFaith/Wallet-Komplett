...
const dict: Translations = {
  ...
  'win.termsPrizeBody':     { de: '{reward} D.FAITH Credits pro Gewinner:in, solange Plätze im Rahmen dieses Gewinnspiels verfügbar sind. Die Gutschrift erfolgt auf das D.FAITH-Konto, das mit dem verifizierten Social-Media-Account verknüpft ist.', en: '{reward} D.FAITH Credits per winner, while spots for this giveaway remain available. Credits are added to the D.FAITH account linked to the verified social media account.', pl: '{reward} kredytów D.FAITH na zwycięzcę, dopóki dostępne są miejsca w ramach tego konkursu. Kredyty są dodawane do konta D.FAITH powiązanego ze zweryfikowanym kontem w mediach społecznościowych.' },
  ...
  'gw.creditPerWinnerLabel': { de: 'Credits / Gewinner',          en: 'Credits / winner',            pl: 'Kredyty / zwycięzcę' },
  'gw.maxWinnersLabel':     { de: 'Max. Gewinner',                en: 'Max. winners',                pl: 'Maks. zwycięzców' },
  ...
  'gw.winnersProgress':     { de: '{count} / {max} Gewinner · {reward} Credits je Gewinner', en: '{count} / {max} winners · {reward} credits per winner', pl: '{count} / {max} zwycięzców · {reward} kredytów na zwycięzcę' },
