                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-end">
                        <div className="space-y-1">
                          <div className="text-yellow-400 font-bold text-lg flex items-center gap-2 drop-shadow-[0_2px_8px_rgba(250,204,21,0.5)]">
                          ...
                          <div className="text-white font-medium text-sm flex items-center gap-1.5">
                            <FaEuroSign className="text-xs text-gray-300" />
