      ...
      <div className="p-4 md:p-3 space-y-3 md:space-y-2">
        ...
        {isCompleted ? (
          ...
          <button
            ...
            disabled={!isVerified}
            className={`w-full ${typeConfig.bg} text-white text-sm font-semibold py-2.5 md:py-2 rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed`}
          >
