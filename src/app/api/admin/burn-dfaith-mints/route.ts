/**
 * POST /api/admin/burn-dfaith-mints — TEMPORÄR (2026-07-15)
 * Header: x-admin-secret
 *
 * Verbrennt die volle Treasury-Balance und schließt die Treasury-ATA für
 * jeden der 6 D.FAITH-Testmints (5 ohne Metadata + der ursprüngliche).
 * Die Mint-Accounts selbst können nicht geschlossen werden (SPL Token
 * Program unterstützt kein CloseMint) — nur die ATA-Rent kommt zurück.
 */
...
const MINTS = [
  '9jB95PZQ2eYs83upTpDv7gqMvuMVtB55QRATZajnmki6',
  'F8pEkVyrdrTJxgA5CHaKPxAXrHAfzoiYnevw4e8k9DFu',
  'J226mwRLEiNLDoVgJ8kpGeJ8AayRqUJ3iwWZoHWVcTJD',
  '9f4aNQh1Ge89YqWE3kbuDjyJzREseeAKPwBaRBPkiYnK',
  'J49boipHdp6B2jtv4vxQdiAGffeVVgZby7meGwwCnLbL',
  'AdxviTpDH5fPCMByFa537zrJncSfsdrLWgDUnsKDUBoj',
];
