...
/**
 * GET /api/cron/reputation-distribute
 *
 * Verteilt abgelaufene Reputation-Contests und Quartals-Leaderboard-Rewards
 * automatisch, ohne dass der Artist manuell auf "Verteilen" klicken muss.
 * distributeReputationContest/distributeLeaderboardQuarterly prüfen selbst,
 * ob das jeweilige Ende schon erreicht ist bzw. schon verteilt wurde — hier
 * wird einfach für jeden Kandidaten versucht und "läuft noch"/"bereits
 * verteilt" stillschweigend übersprungen.
 */
